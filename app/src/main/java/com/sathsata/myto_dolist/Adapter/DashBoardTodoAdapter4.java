...
public class DashBoardTodoAdapter4 extends RecyclerView.Adapter<DashBoardTodoAdapter4.ViewHolder> {
    ...
    public DashBoardTodoAdapter4(TodoDatabase db, DashboardFragment activity) {
        this.db = db;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.task_layout_family_to_dashboard, parent, false);
        return new DashBoardTodoAdapter4.ViewHolder(itemView);
    }
    ...
    public void editItem(int position) {
        ...
        fragment.show(activity.getSupportFragmentManager(), AddNewTaskFamily.TAG); // Show the AddNewTaskFamily fragment
    }
