package com.sathsata.myto_dolist.Utils;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String TODO_TABLE_PERSONAL = "todo_personal";
    ...
    public void insertTaskPersonal(TodoModel task){
        ContentValues cv = new ContentValues();
        cv.put(TASK, task.getTask());
        cv.put(STATUS, 0);
    ...
    @SuppressLint("Range")
    public List<TodoModel> getAllPersonalTasks(){
        List<TodoModel> taskList = new ArrayList<>();
        Cursor cur = null;
        db.beginTransaction();
        try{
            cur = db.query(TODO_TABLE_PERSONAL, null, null, null, null, null, null, null);
